...
export const COURSES: Course[] = [
  {
    ...
    desc: "Trabajos en alturas — nivel básico. Persona autorizada para ejecutar tareas en altura con uso correcto del EPP y procedimientos seguros.",
    tema: "Trabajos en alturas — nivel básico",
  ...
  },
  {
    ...
    desc: "Trabajos en alturas — nivel intermedio. Persona competente con criterio para identificar riesgos, planear maniobras y emitir permisos.",
    tema: "Trabajos en alturas — nivel intermedio",
  ...
  },
  {
    ...
    desc: "Trabajos en alturas — nivel avanzado. Monitor supervisor capaz de dirigir cuadrillas, auditar sistemas y formar personal de menor nivel.",
    tema: "Trabajos en alturas — nivel avanzado",
  ...
  },
  {
    ...
    short: "Andamios",
    desc: "Armado y desarmado de andamios. Armado, inspección y operación segura de andamios multidireccionales y de seguridad.",
    tema: "Armado y desarmado de andamios",
    duracion: "6 horas",
    minParticipantes: 20,
    maxParticipantes: 25,
  ...
  },
  {
    ...
    short: "Izajes",
    desc: "Formación técnica en izajes. Planeación, señalización y ejecución segura de maniobras de izaje con grúa y accesorios.",
    tema: "Formación técnica en izajes",
    duracion: "8 horas",
    minParticipantes: 20,
    maxParticipantes: 25,
  ...
  },
  {
    ...
    short: "Plataformas",
    desc: "Operación de plataformas de elevación. Operación segura de plataformas de elevación de personal (manlift, tijera, articuladas).",
    tema: "Operación de plataformas de elevación",
    duracion: "6 horas",
    minParticipantes: 20,
    maxParticipantes: 25,
    precioLocalPersona: "$1,452.00 MXN + IVA",
  ...
  },
  {
    ...
    desc: "Trabajos en alturas sobre superficies horizontales. Trabajo sobre techos, cubiertas y superficies horizontales con riesgo de caída perimetral o a través.",
    tema: "Trabajos en alturas sobre superficies horizontales",
    duracion: "8 horas",
    minParticipantes: 20,
    maxParticipantes: 25,
    precioLocalPersona: "$1,355.00 MXN + IVA",
