...
export const Route = createFileRoute("/servicios")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Servicios · KG Safety" },
      { name: "twitter:description", content: "Cinco divisiones · un solo estándar de seguridad: capacitación, ingeniería, equipos, contratistas y operación." },
    ],
