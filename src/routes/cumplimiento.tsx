...
export const Route = createFileRoute("/cumplimiento")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Cumplimiento · KG Safety" },
      { name: "twitter:description", content: "Toda la evidencia documental que su auditor necesita — emitida por KG Safety." },
    ],
