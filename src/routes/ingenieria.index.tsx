...
export const Route = createFileRoute("/ingenieria")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Ingeniería · Líneas de vida y anclajes · KG Safety" },
      { name: "twitter:description", content: "Seis frentes técnicos · ingeniería a medida · instalación nacional con pruebas de carga y plan de mantenimiento." },
    ],
