...
export const Route = createFileRoute("/capacitacion")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Capacitación DC-3 · STPS · KG Safety" },
      { name: "twitter:description", content: "DC-3 STPS y Agente Capacitador Externo Working at Heights. 7 cursos vigentes." },
    ],
