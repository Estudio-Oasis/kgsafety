...
export const Route = createFileRoute("/equipos")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Equipos certificados · KG Safety" },
      { name: "twitter:description", content: "10 líneas de producto · 30+ marcas representadas · venta, asesoría técnica y certificación de equipos." },
    ],
